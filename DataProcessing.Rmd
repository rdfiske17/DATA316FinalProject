...
agg_data_male <- agg_data %>%
  select(country, Year, Life.expectancy.at.birth..years..1, GDP.per.capita..PPP..constant.2017.international..., Population..historical.estimates., Human.Development.Index, headcount_ratio_international_povline, Average.Total.Years.of.Schooling.for.Adult.Population..Lee.Lee..2016...Barro.Lee..2018..and.UNDP..2018...x) %>%
  mutate(sex = "Male") %>%
...
agg_data_female <- agg_data %>%
  select(country, Year, Life.expectancy.at.birth..years..2, GDP.per.capita..PPP..constant.2017.international..., Population..historical.estimates., Human.Development.Index, headcount_ratio_international_povline, Average.Total.Years.of.Schooling.for.Adult.Population..Lee.Lee..2016...Barro.Lee..2018..and.UNDP..2018...x) %>%
  mutate(sex = "Female") %>%
...
write_csv(final_data, file="life_expectancy_data.csv")
