...
#VEH
(beta1[3]/100) #We predict a difference in one percent of annual income negatively corresponds to a difference in 0.0003179087 [PRETTY UP!]
...
ggplot(mn_pums, aes(x = log(JWMNP))) +
  ...
  labs(title = "Travel Time to Work vs. Predicted Income", x = "Travel Time (min)", y = "Predicted Income")
...
ggplot(mn_pums, aes(x = VEH)) +
  ...
  labs(title = "Household Vehicles Owned vs. Predicted Income", x = "Number of Vehicles", y = "Predicted Income")
...
ggplot(mn_pums, aes(x = WKHP)) +
  ...
  labs(title = "Average Hours Worked per Week vs. Predicted Income", x = "Average Hours Worked per Week", y = "Predicted Income")
